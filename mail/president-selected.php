...
$namePresident = isset($submission->presidentPerson) ? $submission->presidentPerson->person->fullName : "";
...
<table>
    <tbody>
        <tr>
            <td colspan="4" style="text-indent: 50px;"> <?= Yii::t('app', 'ขอความอนุเคราะห์ท่านเลือกประเภทการพิจารณาเพื่อขอรับการพิจารณาจริยธรรมการวิจัยในมนุษย์') ?>  <?= $submission->submissionType->name ?> <?= Yii::t('app', 'เลขที่') ?> <?= $submission->project->project_code; ?></td>
        </tr>
        <tr>
