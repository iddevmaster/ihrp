...
<p><?= Yii::t('app', 'เรียน') ?> <?= $meeting->checkedSecretaryFirst->person->fullName ?></p>
<p><?= Yii::t('app', 'เรื่อง') ?> <?= \Yii::t('app', 'แจ้งเรื่องให้เลขาท่านที่ 1 ทำการตรวจสอบวาระการประชุม', [isset($meeting) ? $meeting->fullName : ""]) ?></p>
<p>
    เจ้าหน้าที่ตรวจสอบแล้ว รบกวนให้เลขา ท่านที่ 1 ตรวจสอบความถูกต้องด้วยค่ะ
