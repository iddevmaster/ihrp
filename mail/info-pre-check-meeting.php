...
<p><?= Yii::t('app', 'เรียน') ?> <?= $meeting->checkedPresident->person->fullName ?></p>
<p><?= Yii::t('app', 'เรื่อง') ?> <?= \Yii::t('app', 'แจ้งเรื่องให้ประธานทำการตรวจสอบวาระการประชุม', [isset($meeting) ? $meeting->fullName : ""]) ?></p>
<p>
    เนื่องจากเลขาฯในที่ประชุมตรวจสอบแล้ว รบกวนให้ประธานฯในที่ประชุมตรวจสอบความถูกต้องด้วยค่ะ
