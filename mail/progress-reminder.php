...
<h4>เรื่อง แจ้งเตือนรายงานความก้าวหน้าโครงการ</h4>
<table>
    <tbody>
        <tr>
        ...
        <tr>
            <td>วันที่ต้องรายงานความก้าวหน้า</td>
            <td><?= Yii::$app->formatter->asDate($submission->next_progress_at) ?></td>
        </tr>
    </tbody>
</table>
...
<h4>Subject: Research Protocol Progress Reminder Notification</h4>
<table>
    <tbody>
        <tr>
