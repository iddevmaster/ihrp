 ...
 */
class JobCategoryController extends RbacController {
    ...
    public function actionView($id) {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => Yii::t('app', "ความชำนาญในที่ประชุม {name}", [
                    'name' => $model->name
                ]),
    ...
    public function actionCreate() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "เพิ่มความชำนาญในที่ประชุม"),
                ...
                $model = new JobCategory();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', "เพิ่มความชำนาญในที่ประชุมเรียบร้อยแล้ว"));
                return [
                    'forceReload' => '#crud-datatable-job-category-pjax',
                    'title' => Yii::t('app', "เพิ่มความชำนาญในที่ประชุม"),
                    'content' => $this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id) {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "แก้ไขความชำนาญในที่ประชุม {name}", [
                        'name' => $model->name
                    ]),
    ...
    /**
     * Delete an existing JobCategory model.
     * For ajax request will return json object
    ...
    public function actionDelete($id) {
        ...
        if ($request->isAjax) {
             ...
             */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose' => true, 'forceReload' => '#crud-datatable-job-category-pjax'];
        } else {
            /*
             *   Process for non-ajax request
             */
    ...
    /**
     * Delete multiple existing JobCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
