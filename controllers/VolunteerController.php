 ...
 */
class VolunteerController extends RbacController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', "เพิ่ม Volunteer"),
                ...
                $model = new Volunteer();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', 'เพิ่มข้อมูล volunteer เรียบร้อยแล้ว'));
                return [
                    'forceReload'=>'#crud-datatable-volunteer-pjax',
                    'title'=> Yii::t('app', "เพิ่ม Volunteer"),
                    'content'=>$this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', "แก้ไข") . " Volunteer #".$id,
                ...
                return [
                    'forceReload'=>'#crud-datatable-volunteer-pjax',
                    'title'=> Yii::t('app', "แก้ไข") . " Volunteer #".$id,
                    'content' => '<div class="alert alert-success dark">' . Yii::t('app', 'แก้ไขข้อมูล volunteer เรียบร้อยแล้ว') . '</div>',
                    'footer'=> Html::button(Yii::t('app', 'ปิด'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a(Yii::t('app', 'แก้ไข'),['update','id'=>$id],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
            }else{
    ...
    /**
     * Delete an existing Volunteer model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose'=>true,'forceReload'=>'#crud-datatable-volunteer-pjax'];
        }else{
            /*
            *   Process for non-ajax request
            */
     ...
     /**
     * Delete multiple existing Volunteer model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
