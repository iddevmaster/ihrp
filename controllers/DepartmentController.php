...
class DepartmentController extends RbacController {
    ...
    public function actionCreate() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                $model = new Department();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', "เพิ่มหน่วยงานเรียบร้อยแล้ว"));
                return [
                    'forceReload' => '#crud-datatable-department-pjax',
                    'title' => Yii::t('app', "เพิ่มหน่วยงาน"),
                    'content' => $this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id) {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "แก้ไขหน่วยงาน {name}", [
                        'name' => $model->name
                    ]),
    ...
    public function actionDelete($id) {
        ...
        if ($request->isAjax) {
             ...
             */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose' => true, 'forceReload' => '#crud-datatable-department-pjax'];
        } else {
            /*
             *   Process for non-ajax request
             */
