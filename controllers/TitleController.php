 ...
 */
class TitleController extends RbacController {

    protected $allowedActions = ['info'];
    /**
     * @inheritdoc
     */
    ...
    public function actionView($id) {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => Yii::t('app', "คำนำหน้าชื่อ {name}", [
                    'name' => $model->name
                ]),
    ...
    public function actionCreate() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "เพิ่มคำนำหน้าชื่อ"),
                ...
                $model = new Title();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', "เพิ่มคำนำหน้าชื่อเรียบร้อยแล้ว"));
                return [
                    'forceReload' => '#crud-datatable-title-pjax',
                    'title' => Yii::t('app', "เพิ่มคำนำหน้าชื่อ"),
                    'content' => $this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id) {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "แก้ไขคำนำหน้าชื่อ {name}", [
                        'name' => $model->name
                    ]),
    ...
    public function actionDelete($id) {
        ...
        if ($request->isAjax) {
             ...
             */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose' => true, 'forceReload' => '#crud-datatable-title-pjax'];
        } else {
            /*
             *   Process for non-ajax request
             */
