...
use app\models\MeetingRoomSearch;
 ...
 */
class MeetingRoomController extends RbacController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionView($id) {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => Yii::t('app', "ห้องประชุม {name}", [
                    'name' => $model->name
                ]),
    ...
    public function actionCreate() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "เพิ่มห้องประชุม"),
                ...
                $model = new MeetingRoom();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', "เพิ่มห้องประชุมเรียบร้อยแล้ว"));
                return [
                    'forceReload' => '#crud-datatable-meeting-room-pjax',
                    'title' => Yii::t('app', "เพิ่มห้องประชุม"),
                    'content' => $this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id) {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "แก้ไขห้องประชุม {name}", [
                        'name' => $model->name
                    ]),
    ...
    /**
     * Delete an existing MeetingRoom model.
     * For ajax request will return json object
    ...
    public function actionDelete($id) {
        ...
        if ($request->isAjax) {
             ...
             */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose' => true, 'forceReload' => '#crud-datatable-meeting-room-pjax'];
        } else {
            /*
             *   Process for non-ajax request
             */
    ...
    /**
     * Delete multiple existing MeetingRoom model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
