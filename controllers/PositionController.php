 ...
 */
class PositionController extends RbacController {
    ...
    public function actionView($id) {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => Yii::t('app', "ตำแหน่งงาน {name}", [
                    'name' => $model->name
                ]),
    ...
    public function actionCreate() {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "เพิ่มตำแหน่งงาน"),
                ...
                $model = new Position();
                Yii::$app->session->setFlash(Alert::TYPE_SUCCESS, Yii::t('app', "เพิ่มตำแหน่งงานเรียบร้อยแล้ว"));
                return [
                    'forceReload' => '#crud-datatable-position-pjax',
                    'title' => Yii::t('app', "เพิ่มตำแหน่งงาน"),
                    'content' => $this->renderAjax('create', [
                        'model' => $model,
                    ]),
    ...
    public function actionUpdate($id) {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('app', "แก้ไขตำแหน่งงาน {name}", [
                        'name' => $model->name
                    ]),
    ...
    public function actionDelete($id) {
        ...
        if ($request->isAjax) {
             ...
             */
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['forceClose' => true, 'forceReload' => '#crud-datatable-position-pjax'];
        } else {
            /*
             *   Process for non-ajax request
             */
