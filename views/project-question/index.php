...
/* @var $searchModel app\models\ProjectQuestionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'คำถามเพิ่มเติมตอนประชุม');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="project-question-index">
    <div class="ajaxCrudDatatable">
        <?=
        GridView::widget([
            'id' => 'crud-datatable-project-question',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'เพิ่มคำถามเพิ่มเติมตอนประชุม'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
