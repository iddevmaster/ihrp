...
/* @var $searchModel app\models\SubmissionCoiPersonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

//$this->title = Yii::t('app', 'Submission Coi People');
//$this->params['breadcrumbs'][] = $this->title;
//
//CrudAsset::register($this);

?>
<div class="submission-coi-person-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-submission-coi-person',
...
//            ],
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'บุคลากรที่เป็น COI'), ['submission-coi-person/create','submissionId'=>$submissionId], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
