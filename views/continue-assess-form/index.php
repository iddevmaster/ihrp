...
/* @var $searchModel app\models\ContinueAssessFormSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Continue Assess Forms');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="continue-assess-form-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-continue-assess-form',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'Continue Assess Forms'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
