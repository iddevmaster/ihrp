...
$this->title = Yii::t('app', 'ตำแหน่งงาน');
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'ตำแหน่งงาน'), ['position/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
