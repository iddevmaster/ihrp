...
$this->title = Yii::t('app', 'กลุ่มของผู้ปฏิบัติงาน');
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'กลุ่มของผู้ปฏิบัติงาน'), ['panel/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
