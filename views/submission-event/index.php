...
/* @var $searchModel app\models\SubmissionEventSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Submission Events');
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'Submission Events'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
