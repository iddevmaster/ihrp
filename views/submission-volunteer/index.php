...
<div class="submission-volunteer-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-submission-volunteer',
...
//                'beforeGrid' => $this->render('_search', ['model'=>$searchModel]),
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'อาสาสมัคร'), ['submission-volunteer/create', 'projectId' => $submission->project_id, 'submissionId' => $submission->id], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised btn-add-submission-volunteer']) .
