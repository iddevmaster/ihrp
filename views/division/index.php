...
$this->title = Yii::t('app', 'ภาค/สาขาวิชา');
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'ภาค/สาขาวิชา'), ['division/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
