...
/* @var $searchModel app\models\DeviationEventSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Deviation Events');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="deviation-event-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-deviation-event',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'Deviation Events'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
