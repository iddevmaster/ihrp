...
/* @var $searchModel app\models\AgendaResultDocumentSearch */
...
?>
<div class="agenda-result-document-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id' => 'crud-datatable-agenda-result-document',
...
//            ],
            'columns' => require(__DIR__ . '/_columns-agenda.php'),
            'toolbar' => [
                [
                    'options' => [
                        'class' => '',
