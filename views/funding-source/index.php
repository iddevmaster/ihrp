...
<div class="funding-source-index">
    <div id="ajaxCrudDatatable">
       <?=
        GridView::widget([
            'id' => 'crud-datatable-funding-source',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'แหล่งทุน'), ['funding-source/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
