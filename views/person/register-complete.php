...
<div class="register-transaction-create col-md-12 col-md-offset-3">
    <div class="panel" id="exampleWizardFormContainer">
        <div class="panel-body">
            ...
            <h1 class="text-center"><?= Yii::t('app', 'ลงทะเบียนเรียบร้อยแล้ว') ?></h1>
            <h1 class="text-center text-danger"><?= Yii::t('app', 'กรุณายืนยันการลงทะเบียนทางอีเมล์ ที่ระบบส่งให้ก่อนเริ่มใช้งาน') ?></h1>
