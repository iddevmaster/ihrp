...
//    \yii\helpers\VarDumper::dump($data, 10, TRUE);
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="red-600"><?= Yii::t('app', 'สิทธิในการเข้าถึงระบบ สำหรับนักศึกษา ป.ตรี ที่จะยื่นโครงการ ให้กดเลือกทั้ง 2 สถานะ และยื่นโครงการโดยเป็นผู้ประสานงาน เลือก อ.ที่ปรึกษาเป็นผู้วิจัยหลัก (นักศึกษา ป.ตรี ยังไม่สามารถเป็นหัวหน้าเองได้)') ?></div>
