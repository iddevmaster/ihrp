...
return [
    ...
    [
        ...
        'template' => '{select}',
        'buttons' => [
            'select' => function($url, $model) use ($selectPerson) {
                $options = ['role' => 'modal-remote', 'title' => 'เลือก', 'data-toggle' => 'tooltip'];
                return Html::a('<i class="icon md-arrow-right font-size-18"></i>', ['person-role/select-persons', 'id' => $_GET['id'], 'personId' => $model->id, 'roleId' => $_GET['id'],'co'=>1], $options);
            },
        ],
