...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'บุคลากร'), ['person/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
