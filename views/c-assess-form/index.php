...
/* @var $searchModel app\models\CAssessFormSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'C Assess Forms');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="cassess-form-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-cassess-form',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'C Assess Forms'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
