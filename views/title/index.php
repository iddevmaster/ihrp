...
$this->title = Yii::t('app', 'คำนำหน้าชื่อ');
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'คำนำหน้าชื่อ'), ['title/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
