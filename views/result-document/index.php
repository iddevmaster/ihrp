...
/* @var $searchModel app\models\ResultDocumentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'ทะเบียนหนังสือแจ้งผลต้นแบบ');
$this->params['breadcrumbs'][] = ['label' => 'จัดการค่าตั้งต้น', 'url' => ['site/master-list']];
$this->params['breadcrumbs'][] = $this->title;
//CrudAsset::register($this);

?>
<div class="result-document-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-result-document',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'หนังสือแจ้งผลต้นแบบ'), ['result-document/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
