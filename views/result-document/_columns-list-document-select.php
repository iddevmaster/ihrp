...
return [
        ...
        'buttons' => [
            'select' => function($url, $model) use ($selectDocument) {
                ...
                return Html::a('<i class="icon md-arrow-right font-size-18"></i>', ['agenda-result-document/select-documents', 'id' => $_GET['id'], 'documentId' => $model->id, 'agendaId' => $_GET['id'],], $options);
            },
        ],
