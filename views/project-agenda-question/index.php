...
/* @var $searchModel app\models\ProjectAgendaQuestionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Project Agenda Questions');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="project-agenda-question-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-project-agenda-question',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'Project Agenda Questions'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
