...
//        },
        ...
        'buttons' => [
            'assess' => function($url, $model) use ($sCommitteeId) {
                return Html::a(Yii::t('app', 'ประเมิน'), ['deviation-event/create', 'submissionEventId' => $model->id, 'sCommitteeId' => $sCommitteeId], ['class' => 'btn btn-primary btn-xs btn-round', 'role' => 'modal-remote', 'data-toggle' => 'tooltip']);
            },
        ],
        'visibleButtons' => [
            'assess' => function($model) {
                return Yii::$app->util->checkPermission('deviation-event.create');
            },
        ],
    ],
];
