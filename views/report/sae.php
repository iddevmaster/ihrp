    ...
    foreach ($dataProvider->models as $m) :
        ...
        <div class="panel panel-bordered margin-bottom-10">
            <div class="padding-10" style="padding: 10px;">
                <h3 class="card-title"><font style="font-weight: bold;" color="#073453;"><?= Yii::t('app', 'หมายเลขโครงการ : ') . $m->project->project_code ?> <?= Yii::t('app', 'ผู้วิจัยหลัก : ') . $m->projectLeader->person->fullName ?> </font></h3>
