...
<div class="submission-search">
    ...
    <div class="row">
        <div class="col-md-2">
            <?=
            $form->field($searchModel, 'startYear')->label(false)->widget(Select2::classname(), [
                'data' => Yii::$app->util->selectYears,
                'options' => ['placeholder' => 'จากปี'],
                'pluginOptions' => [
                    'allowClear' => true,
                    // 'width' => '250px',
                ],
        ...
        <div class="col-md-2">
            <?=
            $form->field($searchModel, 'endYear')->label(false)->widget(Select2::classname(), [
                'data' => Yii::$app->util->selectYears,
                'options' => ['placeholder' => 'ถึงปี'],
                'pluginOptions' => [
                    'allowClear' => true,
                    // 'width' => '250px',
                ],
