    ...
    [
        ...
        'buttons' => [
            'ckdoc' => function($url, $model) {
                return \yii\helpers\Html::a('<i class="glyphicon glyphicon-check"></i>', ['submission-committee/comment'], ['role' => 'modal-remote', 'data-toggle' => 'tooltip', 'target' => '_blank', 'title' => 'ตรวจสอบเอกสาร', 'class' => 'btn btn-info btn-raised']);
            },
