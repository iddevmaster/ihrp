...
//            'filterModel' => $searchModel,
            ...
            'pjax' => true,
            'pjaxSettings' => [
                'beforeGrid' => $this->render('_search-continue', ['searchModel' => $searchModel]),
            ],
            'columns' => require(__DIR__ . '/_columns-continue.php'),
            'toolbar' => [
                    [
                    'options' => [
                        'class' => '',
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'ส่งงานวิจัยต่อเนื่อง'), ['site/submission-continue'], [ 'class' => 'btn btn-success btn-raised']) .
