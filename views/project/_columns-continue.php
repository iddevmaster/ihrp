    ...
    [
        ...
        'buttons' => [
            ...
            'number' => function($url, $model) {
                return \yii\helpers\Html::a('<i class="glyphicon glyphicon-plus"></i>', ['agenda-transaction/create?meetingId=' . $model->id], ['role' => 'modal-remote', 'data-toggle' => 'tooltip', 'title' => 'กำหนดเลขโครงการ', 'class' => 'btn btn-primary btn-raised']);
            },
        ]
    ],
];
