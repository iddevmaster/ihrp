...
/* @var $searchModel app\models\MeetingRoomSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'ห้องประชุม');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'การจัดการค่าตั้งต้น'), 'url' => ['site/master-list']];
...
<div class="meeting-room-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-meeting-room',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'ห้องประชุม'), ['meeting-room/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
