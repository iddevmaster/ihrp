...
/* @var $searchModel app\models\CommitteePositionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'ตำแหน่งกรรมการ');
...
?>
<div class="committee-position-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-committee-position',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่มตำแหน่งกรรมการ'), ['committee-position/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
