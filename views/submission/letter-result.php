...
//            ],
            'columns' => require(__DIR__ . '/_letter-result-columns.php'),
            'toolbar' => [
                [
                    'options' => [
                        'class' => '',
                    ...
                    'content' =>
                   $currentRole['role_id'] == \app\models\Role::STAFF || $currentRole['role_id'] == \app\models\Role::ADMIN ?  Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'เพิ่มเอกสารอื่นๆ'), ['submission-result-document/create', 'submissionId' => $submission->id,'pjaxId'=>$pjaxId], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) : "" .
