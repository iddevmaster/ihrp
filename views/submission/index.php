...
<div class="submission-index ">
    <div class="ajaxCrudDatatable" >
        <?php if ($currentRole['role_id'] != app\models\Role::COPRESIDENT && $currentRole['role_id'] != app\models\Role::PRESIDENT && $currentRole['role_id'] != app\models\Role::SECRETARY   ) { ?>
            <?= $this->render('_search', ['searchModel' => $searchModel, 'url' => isset($url) ? $url : null,'staff'=> isset($staff)? $staff:"",'status'=>isset($status)? $status : "",'typeGroup'=>isset($typeGroup)? $typeGroup : "",'type'=>isset($type)? $type : ""]) ?>
        <?php } ?>
        <?=
        GridView::widget([
...
//            'filterModel' => $searchModel,
            ...
            'striped' => true,
            'condensed' => true,
//            'responsive' => !\Yii::$app->devicedetect->isMobile(),
//            'responsive' => !\Yii::$app->devicedetect->isMobile(),
            'panel' => [
                'type' => 'info',
