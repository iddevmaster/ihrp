...
$this->title = Yii::t('app', 'ยื่นเสนอโครงการวิจัยต่อเนื่อง');
//exit;
?>
        ...
        <div class="panel-body">
            ...
            <div class="pearls row">
                <?php foreach ($steps as $st): ?>
                    <div class="pearl col-xs-2 <?= \app\controllers\SubmissionController::getStepClass($st, $step) ?>">
            ...
            <!-- Wizard Content -->
            <?php
            $action = ['submission/continue'];
            if (isset($submission->id)) {
                $action['submissionId'] = $submission->id;
                $action['projectId'] = $submission->project_id;
                $action['step'] = $step;
            }
//            yii\helpers\VarDumper::dump(Url::to($action));
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::CONT_STEP1 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
                $this->render('_cont-step1', [
                    'form' => $form,
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::CONT_STEP2 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
...
//                    'searchModel' => $researcherSearch,
                    ...
                    'steps' => $steps,
                    'step' => $step,
                    'reloadUrl' => ['submission/continue', 'submissionId' => $submission->id, 'step' => $step],
                ]);
                ?>
            </div>
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::CONT_STEP3 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::CONT_STEP4 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::CONT_STEP5 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
