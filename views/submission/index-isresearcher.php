...
//$this->title = Yii::t('app', 'งานวิจัยที่เป็นอาจารย์ที่ปรึกษา');
...
//            'filterModel' => $searchModel,
            ...
            'pjaxSettings' => [
                ...
                'beforeGrid' => $this->render('_search-show', ['searchModel' => $searchModel]),
            ],
            'columns' => require(__DIR__ . '/_columns-isconsultant.php'),
            'toolbar' => [
                    [
                    'options' => [
                        'class' => '',
