...
$this->title = Yii::t('app', 'รายงานสถิติระยะเวลาการพิจารณา');
...
$fullExportMenu = ExportMenu::widget([
            ...
            'columns' => require(__DIR__ . '/_columns-report-duration.php'),
...
<div class="submission-index ">
    ...
    <div id="ajaxCrudDatatable" >
        <?= $this->render('_search-report-duration', ['searchModel' => $searchModel,'staff'=> isset($staff)? $staff:"",'status'=>isset($status)? $status : "",'submissionTypeGroupId'=>isset($submissionTypeGroupId)? $submissionTypeGroupId : ""]) ?>
