...
<div class="submission-search">
    ...
    $form = ActiveForm::begin([
                'method' => 'get',
                'action' => isset($url) ? base64_decode($url) : Url::to(['submission/index']),
...
//                $data = ArrayHelper::map(app\models\SubmissionType::find()->isDeleted(FALSE)->group($searchModel->submission_type_group_id)->orderBy('CONVERT(submission_type.name USING TIS620)')->all(), 'id', 'name');
