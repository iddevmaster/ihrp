...
$this->title = Yii::t('app', 'ยื่นแก้ไขโครงการมติ C, มติ R');
}else{
...
//            yii\helpers\VarDumper::dump(Url::to($action));
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::NEW_STEP1 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::NEW_STEP2 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
...
//                    'searchModel' => $researcherSearch,
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::NEW_STEP3 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::NEW_STEP4 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
            ...
            <div class="wizard-pane <?= $step == \app\controllers\SubmissionController::NEW_STEP5 ? '' : 'hidden' ?>" role="tabpanel">
                <?=
