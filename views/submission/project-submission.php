...
$isResearcherRole = isset($currentRoles['role_id']) && $currentRoles['role_id'] == \app\models\Role::RESEARCHER;
$isApprovalResolution = $submission->resolution == Submission::RESOLUTION_Y
        || (isset($submission->crec_resolution) && $submission->crec_resolution == Submission::RESOLUTION_Y);
