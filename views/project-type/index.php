...
$this->title = Yii::t('app', 'ประเภทโครงการ');
...
<div class="project-type-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-project-type',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่มประเภทโครงการ'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
