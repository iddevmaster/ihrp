...
$this->title = Yii::t('app', 'เอกสารประกอบงานวิจัย');
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'เอกสารประกอบงานวิจัย'), ['document/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
