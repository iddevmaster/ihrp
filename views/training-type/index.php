...
/* @var $searchModel app\models\TrainingTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'ประเภทการอบรม');
...
<div class="training-type-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-training-type',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่มประเภทการอบรม'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
