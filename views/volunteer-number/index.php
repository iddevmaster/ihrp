...
/* @var $searchModel app\models\VolunteerNumberSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'อาสาสมัคร');
...
?>
<div class="volunteer-number-index">
    <div id="ajaxCrudDatatable">
       <?=
        GridView::widget([
            'id' => 'crud-datatable-volunteer-number',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'อาสาสมัคร'), ['volunteer-number/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
