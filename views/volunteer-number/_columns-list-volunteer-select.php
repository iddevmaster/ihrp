    ...
    [
        ...
        'buttons' => [
            'select' => function($url, $model) use ($selectDocument) {
                ...
                return Html::a('<i class="icon md-arrow-right font-size-18"></i>', ['submission-type-volunteer-number/select-volunteers', 'id' => $_GET['id'], 'volunteerId' => $model->id, 'submissionTypeId' => $_GET['id']], $options);
            },
        ],
