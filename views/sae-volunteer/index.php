...
/* @var $searchModel app\models\SaeVolunteerSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Sae Volunteers');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="sae-volunteer-index">
    <div class="ajaxCrudDatatable">
        <?=GridView::widget([
            'id'=>'crud-datatable-sae-volunteer',
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'เพิ่ม') . Yii::t('app', 'Sae Volunteers'), ['create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
