...
/* @var $searchModel app\models\DocumentSubmisstionTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'กำหนดแบบประเมินสำหรับกรรมการ ');
...
<div class="submission-type-volunteer-number-index">
    <div id="ajaxCrudDatatable">
       <?=
        GridView::widget([
            'id' => 'crud-datatable-submission-type-number',
...
//            ],
            'columns' => require(__DIR__ . '/_columns-submission-type.php'),
            'toolbar' => [
                [
                    'options' => [
                        'class' => '',
