...
/* @var $searchModel app\models\QuestionnaireTitleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'แบบประเมินสำหรับกรรมการ');
$this->params['breadcrumbs'][] = ['label' => 'จัดการค่าตั้งต้น', 'url' => ['site/master-list']];
$this->params['breadcrumbs'][] = ['label' => 'เลือกประเภทโครงการวิจัย', 'url' => ['questionnaire-title/index-list-submission-type']];
$this->params['breadcrumbs'][] = $this->title;
//
//CrudAsset::register($this);

?>
<div class="questionnaire-title-index">
    <div id="ajaxCrudDatatable">
        <?=
        GridView::widget([
            'id' => 'crud-datatable-questionnaire-title',
...
//            ],
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'แบบประเมินสำหรับกรรมการ'), ['questionnaire-title/create', 'submissionTypeId' => $id], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
