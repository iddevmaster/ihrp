...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' .Yii::t('app', 'ข้อมูลการอบรม'), ['person-training/create','personId'=>$searchModel->person_id], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
