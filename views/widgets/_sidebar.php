...
//                                                        <span class="site-menu-title">หน้าหลัก</span>', 'encode' => false, 'url' => ['site/index']],
                        ...
                        ['label' => Html::tag('i', '', ['class' => 'site-menu-icon icon ion-android-contacts']) . Html::tag('span', yii::t('app', 'งานวิจัยที่เป็นผู้ร่วมวิจัย'), ['class' => 'site-menu-title', 'title' => yii::t('app', 'งานวิจัยที่เป็นผู้ร่วมวิจัย')]), 'url' => ['submission/index-not-isleader'], 'visible' => $currentRole['role_id'] == \app\models\Role::RESEARCHER ],
