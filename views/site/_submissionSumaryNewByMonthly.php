...
$submissionTypes = SubmissionType::find()->isDeleted(false)->group(SubmissionTypeGroup::GROUP_NEW)->internal(false)->all();
$records = [];
...
$title = yii::t('app', 'สรุปจำนวนโครงการวิจัยใหม่ที่เสนอขอรับการรับรองจากที่ประชุมคณะกรรมการฯ จำแนกตามเดือนและประจำสาขาวิชา <Br>');
