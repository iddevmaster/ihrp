...
<div class="organization-index">
    <div id="ajaxCrudDatatable">
        <?=
        GridView::widget([
            'id' => 'crud-datatable-organization',
...
//            'filterModel' => $searchModel,
            ...
            'toolbar' => [
                    ...
                    'content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('app', 'องค์กร'), ['organization/create'], ['role' => 'modal-remote', 'class' => 'btn btn-success btn-raised']) .
