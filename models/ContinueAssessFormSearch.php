...
/**
 * ContinueAssessFormSearch represents the model behind the search form about `app\models\ContinueAssessForm`.
 */
class ContinueAssessFormSearch extends ContinueAssessForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'submission_id', 'review_choice_id', 'resolution_id', 'created_by', 'updated_by'], 'integer'],
