 ...
 * @property string $name กลุ่มของงาน
...
class JobCategory extends \yii\db\ActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'id' => Yii::t('app', 'รหัส'),
            'name' => Yii::t('app', 'กลุ่มของงาน'),
            'name_eng' => Yii::t('app', 'กลุ่มของงาน (ภาษาอังกฤษ)'),
    ...
    public function getPeople() {
        return $this->hasMany(Person::className(), ['job_category_id' => 'id']);
    }
