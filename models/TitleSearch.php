...
/**
 * TitleSearch represents the model behind the search form about `app\models\Title`.
 */
class TitleSearch extends Title
{
    ...
    public function search($params)
    {
        ...
        $dataProvider->sort->attributes['name'] = [
            'asc' => ['CONVERT(title.name USING TIS620)' => SORT_ASC],
            'desc' => ['CONVERT(title.name USING TIS620)' => SORT_DESC],
        ];
        ...
        $query->andFilterWhere([
            'title.id' => $this->id,
            'title.deleted' => $this->deleted,
            'title.created_by' => $this->created_by,
            'title.created_at' => $this->created_at,
            'title.updated_by' => $this->updated_by,
            'title.updated_at' => $this->updated_at,
        ]);

        $query->andFilterWhere(['or',['like', 'title.name', $this->name], ['like', 'title.name_eng', $this->name]]);
