...
/**
 * This is the model class for table "continue_assess_form_review".
 *
 * @property int $id
 ...
 */
class ContinueAssessFormReview extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'continue_assess_form_review';
    }
    ...
    public function rules() {
        return [
            [['continue_assess_form_id', 'review_choice_id', 'deleted', 'created_by', 'updated_by'], 'integer'],
    ...
    /**
     * {@inheritdoc}
     * @return ContinueAssessFormReviewQuery the active query used by this AR class.
     */
    public static function find() {
        return new ContinueAssessFormReviewQuery(get_called_class());
    }
