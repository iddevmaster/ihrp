...
class FundingSource extends \yii\db\ActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'id' => Yii::t('app', 'รหัสแหล่งทุน'),
            'name' => Yii::t('app', 'แหล่งทุน'),
            'name_eng' => Yii::t('app', 'แหล่งทุน(ภาษาอังกฤษ)'),
    ...
    public function getProjects() {
        return $this->hasMany(Project::className(), ['funding_source_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return FundingSourceQuery the active query used by this AR class.
     */
    public static function find() {
        return new FundingSourceQuery(get_called_class());
    }
