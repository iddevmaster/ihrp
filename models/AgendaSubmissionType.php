...
/**
 * This is the model class for table "agenda_submission_type".
 *
 * @property int $id
 ...
 */
class AgendaSubmissionType extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['agenda_id', 'submission_type_id', 'deleted', 'created_by', 'updated_by'], 'integer'],
    ...
    /**
     * @inheritdoc
     * @return AgendaSubmissionTypeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new AgendaSubmissionTypeQuery(get_called_class());
    }
}
