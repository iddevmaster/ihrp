...
/**
 * Class m210419_015531_add_permission
 */
class m210419_015531_add_permission extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $permissionsA = [
            'person.download',
            'person-training.download',
            'submission-result-document.download',
            'document.download',
            'document.download-eng',
    ...
    {
        echo "m210419_015531_add_permission cannot be reverted.\n";
