...
/**
 * Class m190505_080111_update_permission
 */
class m190505_080111_update_permission extends Migration {

    public function safeUp() {
        $auth = Yii::$app->authManager;
        $roleR = $auth->getRole('เจ้าหน้าที่');
        $permissionsR = [
            'submission.change-panel',
        ];
    ...
    /*
      ...
      {
      echo "m190505_080111_update_permission cannot be reverted.\n";
